      ...
      *>   PRINT DEBUG MESSAGE
           ...
           MOVE 2 TO COUNT-CELLS-CURRENT-ROW
           MOVE 2 TO COUNT-CELLS-CURRENT-COLUMN
           PERFORM COUNT-CELLS
           DISPLAY COUNT-CELLS-RESULT
      ...
      *>          DISPLAY COUNT-CELLS-TEMP-ROW
      *>          DISPLAY COUNT-CELLS-TEMP-COLUMN
      *>          DISPLAY PREVIOUS-PATTERN-CELL(
      *>              COUNT-CELLS-TEMP-ROW ,
      *>              COUNT-CELLS-TEMP-COLUMN)
               IF(COUNT-CELLS-TEMP-ROW >= 1
                   AND COUNT-CELLS-TEMP-ROW <= ROW-SIZE AND
                   COUNT-CELLS-TEMP-COLUMN >= 1
                   AND COUNT-CELLS-TEMP-COLUMN <= ROW-SIZE
